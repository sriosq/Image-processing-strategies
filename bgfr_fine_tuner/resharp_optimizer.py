...
def configure_experiment_run(test_fn):
    ...
    iter_folder = rf"E:\msc_data\sc_qsm\final_gauss_sims\July_2025\mrsim_outputs\custom_params/bgfr_opt\iter_resharp/{test_fn}"
    ...
    txt_file_path = rf"E:\msc_data\sc_qsm\final_gauss_sims\July_2025\mrsim_outputs\custom_params/bgfr_opt\iter_resharp/{test_fn}.txt"
    with open(txt_file_path, 'w') as file:
        file.write("Optimization results.\n")

def load_groun_truth_data():
    global wb_gt_avg_sc_ref_swiss_crop_fm_Hz_data
    wb_gt_avg_sc_ref_swiss_crop_fm_Hz_data = nib.load(r"E:\msc_data\sc_qsm\final_gauss_sims\July_2025\ground_truth_data\bgfr_gt_ref_avg_sc_lf_Hz_crop.nii.gz").get_fdata()# This loads the Ground truth image with the Swiss Acq. Parameters FOV
...
configure_experiment_run("RMSE_test2_corrected_gt_lf_VNS_ON")
