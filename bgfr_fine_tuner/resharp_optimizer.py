...
def configure_experiment_run(test_fn):
    ...
    iter_folder = rf"e:\msc_data\sc_qsm\Swiss_data\march_25_re_process\MR_simulations\sim_data\QSM_processing\mrsim_outputs\custom_acq_params\BGFR_tests\iter_resharp/{test_fn}"
...
def resharp_optimizer(x):
    ...
    print(f"Iter {counter}: Radius ={radius}, Regularization parameter: {alpha} GM-WM RMSE={objective_value}")
