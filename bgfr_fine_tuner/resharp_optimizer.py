...
def configure_experiment_run(test_fn):
    ...
    iter_folder = rf"E:\msc_data\sc_qsm\new_gauss_sims\mrsim_outpus\cropped_ideal\bgfr_opt\iter_resharp/{test_fn}"
    ...
    txt_file_path = rf"E:\msc_data\sc_qsm\new_gauss_sims\mrsim_outpus\cropped_ideal\bgfr_opt\iter_resharp/{test_fn}.txt"
...
x0 = [1, 0.007246] # Recommended by SEPIA (for brain)
...
configure_experiment_run("RMSE_test2_mskd_fm_continuation_of_test1")
