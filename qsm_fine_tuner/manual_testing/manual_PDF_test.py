...
#  PDF parameters are tolerance, iteration and padSize
tolerance = 0.1
iteration = 30
padSize = float(40)
...
iter_folder = r"E:\msc_data\sc_qsm\Swiss_data\march_25_re_process\MR_simulations\sim_data\QSM_processing\mrsim_outputs\custom_acq_params\BGFR_tests\manual_testing_pdf"
