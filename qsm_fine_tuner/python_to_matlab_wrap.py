...
def python_to_sepia_bfr_wrap(input_fieldmap, in2, in3, sepia_header, alg, params, out_basename, mask_filename ):
    ''' This is a wrapper for Sepia used to create BGFR algorithms
    '''
