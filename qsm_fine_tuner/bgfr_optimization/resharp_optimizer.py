...
def configure_experiment_run(test_fn, first_line="Optimization results: "):
    ...
    iter_folder = rf"E:\msc_data\sc_qsm\final_gauss_sims\feb_2026\bgfr_opt\snr_70\iter_resharp/{test_fn}"
    ...
    txt_file_path = rf"E:\msc_data\sc_qsm\final_gauss_sims\feb_2026\bgfr_opt\snr_70\iter_resharp/{test_fn}.txt"
    ...
    if obj_value <= best_obj_value:
        if obj_value == best_obj_value:
            ...
            with open(txt_file_path, 'a') as file:
                file.write(f"#Iter {iteration}: OBJ {obj_value} // SMV radius: {radius}, Reg. Param aplha: {alpha}, GM RMSE: {gm_rmse}, WM RMSE: {wm_rmse}\n")
...
first_line = "BGFR optimization of RESHARP @SNR 70:"
