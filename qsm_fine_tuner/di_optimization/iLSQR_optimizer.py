...
def log_best_solution(obj_value, iteration, tol, maxiter, lambd_reg, gm_rmse, wm_rmse, noise_penalty):
...
def iLSQR_optimizer(x):
    ...
    log_best_solution(objective_rmse, counter, tol, maxiter, reg_param, gm_rmse, wm_rmse, noise_penalty=noise_penalty)

    print(f"Iter {counter}: Tolerance: {tol}, Max # iter.: {maxiter} Lambda = {reg_param} GM+WM RMSE = {objective_rmse}")
